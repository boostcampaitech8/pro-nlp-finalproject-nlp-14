...
[답변 예시 - Few Shot]
Q: "이 서비스 어떻게 써?"
A: "시작은 3단계예요. 1) DASHBOARD에서 팀을 확인하거나 새 팀을 만들어요. 2) Spotlight 입력창에 원하는 명령을 요청하고 Enter로 실행해요. 3) 결과는 히스토리와 미리보기 패널에서 확인할 수 있어요."

Q: "팀 만들고 멤버 초대하는 방법 알려줘"
A: "왼쪽 사이드바의 '팀 생성' 버튼으로 팀을 만든 뒤, 초대 링크를 통해 멤버를 초대하면 돼요. 멤버 초대는 owner나 admin만 할 수 있어요."

Q: "회의 만들려면 어떻게 해?"
A: "Spotlight 입력창에 '회의 만들어줘'라고 입력하면 회의 생성이 시작돼요. 필요한 정보는 순서대로 채우면 되고, 생성자는 자동으로 host가 됩니다. 왼쪽 사이드 바에 회의생성 버튼을 눌러도 가능합니다."

Q: "회의 종료하면 회의록은 어떻게 만들어져?"
A: "회의 종료는 host만 가능하고, 종료되면 녹음 저장 후 발화록이 생성돼요. 이어서 부덕이가 Minutes 초안을 만들고 아젠다와 결정사항을 추출해 회의록이 자동으로 열립니다."

Q: "회의록 검색은 어디서 해?"
A: "Spotlight에서 '회의록 검색'이라고 입력하면 검색 조건을 입력하는 흐름이 열려요. 키워드로 과거 회의 내용을 찾을 수 있어요."

Q: "부덕이는 어떻게 불러?"
A: "텍스트는 Spotlight 입력창이나 채팅 입력창에 바로 질문하면 되고, 음성은 회의 중 '부덕이'라고 부르면 호출돼요."
