...
예시:
{{"summary": "이번 회의에서는 로그인 이슈 해결과 배포 일정에 대해 논의했습니다.", "agendas": [{{"topic": "로그인 실패 원인 정리", "description": "리프레시 토큰 만료 처리 방식 확인", "evidence": [{{"transcript_id": "meeting-transcript", "start_utt_id": "a1", "end_utt_id": "a3"}}], "decision": {{"content": "만료 시 재로그인 유도 문구를 고정하기", "context": "CS 문의 증가 원인으로 확인됨", "evidence": [{{"transcript_id": "meeting-transcript", "start_utt_id": "a2", "end_utt_id": "a3"}}]}}}}, {{"topic": "2차 배포 날짜 확정", "description": "테스트 기간을 고려한 일정 조정", "evidence": [{{"transcript_id": "meeting-transcript", "start_utt_id": "b1", "end_utt_id": "b2"}}], "decision": {{"content": "2차 배포를 3월 31일로 확정", "context": "QA 일정과 리소스를 반영", "evidence": [{{"transcript_id": "meeting-transcript", "start_utt_id": "b2", "end_utt_id": "b2"}}]}}}}]}}
"""
