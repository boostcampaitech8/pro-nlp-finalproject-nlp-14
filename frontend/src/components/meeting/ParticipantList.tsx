...
export function ParticipantList({ participants, currentUserId, audioLevels }: ParticipantListProps) {
    ...
    <div className="bg-gray-800 rounded-lg p-4">
      ...
      <ul className="space-y-2">
        {participantArray.map((participant) => {
          ...
          const isSpeaking = audioLevel > 0 && !participant.audioMuted;
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2">
                {/* 아바타 - 발화 시 테두리 효과 */}
                <div
                  className={`w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center text-white text-sm font-medium transition-all ${
